...
class Metaclass_StopRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_interface.srv import _stop_robot
...
class StopRobot(metaclass=Metaclass_StopRobot):
    from my_interface.srv._stop_robot import StopRobot_Request as Request
    from my_interface.srv._stop_robot import StopRobot_Response as Response
